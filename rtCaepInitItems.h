...
*/
#define ID_CaeUnsAeroFXPost  270
{
    /*== CAEP_FORMATINFO FormatInfo */
    {   PWP_SITE_GROUPNAME,     /* const char *group */
        "XPOST",             /* const char *name */
        MAKEGUID(ID_CaeUnsAeroFXPost),  /* PWP_UINT32 id */
    ...
    0, //CaeUnsAeroFXPostBCInfo,            /* CAEP_BCINFO* */
    0, //ARRAYSIZE(CaeUnsAeroFXPostBCInfo), /* PWP_UINT32 BCCnt */

    /*== CAEP_VCINFO*    pVCInfo;    -- array of format VCs or NULL */
    /*== PWP_UINT32      VCCnt;      -- # format VCs */
    0, //CaeUnsAeroFXPostVCInfo,            /* CAEP_VCINFO* pVCInfo */
    0, //ARRAYSIZE(CaeUnsAeroFXPostVCInfo), /* PWP_UINT32 VCCnt */

    /*== const char**    pFileExt;   -- array of valid file extensions */
    /*== PWP_UINT32      ExtCnt;     -- # valid file extensions */
    CaeUnsAeroFXPostFileExt,            /* const char **pFileExt */
    ARRAYSIZE(CaeUnsAeroFXPostFileExt), /* PWP_UINT32 ExtCnt */
